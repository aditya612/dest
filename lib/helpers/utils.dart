...
// // https://neil.fraser.name/news/2011/EncodeDecode.dart
...
//       } else {
//         throw 
//             ArgumentError('URI malformed: Orphaned low surrogate.');
//       }
//       // Skip next character.
//       i++;
//     } else if (0xDC00 <= charCode && charCode < 0xE000) {
//       throw
//           ArgumentError('URI malformed: Orphaned high surrogate.');
...
//       encodedText.write('%').write(hexDigits[byteList[i] >> 4])
...
//         surrogate = true;
//       } else {
//         throw new ArgumentError('URI malformed: Unknown Unicode.');
//       }
//     } else {
//       // All continuation bytes are in the form 10xxxxxx.
//       if ((charCode & 0xC0) != 0x80) {
//         throw new ArgumentError('URI malformed: Expect 10xxxxxx.');
//       }
...
//           throw new 
//               ArgumentError('URI malformed: Invalid surrogate.');
//         }
...
//       if (!parts[i].isEmpty()) {
//         throw new ArgumentError('URI malformed: Incomplete code.');
//       }
//     }
//   }
//   if (state != 0) {
//     throw ArgumentError('URI malformed: Truncated code.');
//   }
