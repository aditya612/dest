...
class ButtonDropdown<T> extends StatefulWidget {
  ...
  @override
  _ButtonDropdownState<T> createState() => _ButtonDropdownState<T>();
}

class _ButtonDropdownState<T> extends State<ButtonDropdown<T>>
              ...
              if (!widget.hideIcon)
                Flexible(
                  child: RotationTransition(
                      ...
                      child:
                          widget.icon ?? Icon(Icons.arrow_drop_down_rounded)),
                ),
            ],
          ),
        ),
