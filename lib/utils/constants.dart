...
const List<String> HTTP_METHODS = [
  METHOD_GET,
  METHOD_POST,
  METHOD_PUT,
  METHOD_PATCH,
...
const AUTH_OAUTH_1 = 'oauth1';
const AUTH_BASIC = 'basic';
const AUTH_DIGEST = 'digest';
const AUTH_BEARER = 'bearer';
const AUTH_NTLM = 'ntlm';
const AUTH_HAWK = 'hawk';
const AUTH_AWS_IAM = 'iam';
const AUTH_NETRC = 'netrc';
const AUTH_ASAP = 'asap';
const HAWK_ALGORITHM_SHA256 = 'sha256';
const HAWK_ALGORITHM_SHA1 = 'sha1';

// json-order constants
const JSON_ORDER_PREFIX = '&';
const JSON_ORDER_SEPARATOR = '~|';
...
const RESPONSE_CODE_DESCRIPTIONS = {
  ...
  101:
      'This code is sent in response to an Upgrade: request header by the client and indicates the protocol the server is switching to. It was introduced to allow migration to an incompatible protocol version, and it is not in common use.',
  // 200s
  ...
  305:
      'This means requested response must be accessed by a proxy. This response code is not largely supported because of security reasons.',
  306:
      'This response code is no longer used and is just reserved currently. It was used in a previous version of the HTTP 1.1 specification.',
  307:
  ...
  401:
      'Authentication is needed to get the requested response. This is similar to 403, but is different in that authentication is possible.',
  402:
      'This response code is reserved for future use. Initial aim for creating this code was using it for digital payment systems, but it is not used currently.',
  403:
      'Client does not have access rights to the content, so the server is rejecting to give proper response.',
  404:
      'Server cannot find requested resource. This response code is probably the most famous one due to how frequently it occurs on the web.',
  405:
